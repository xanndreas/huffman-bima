<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('user.email_credentials') ? 'invalid' : '' }}">
        <label class="form-label required" for="email_credentials">{{ trans('cruds.user.fields.email_credentials') }}</label>
        <input class="form-control" type="text" name="email_credentials" id="email_credentials" required wire:model.defer="user.email_credentials">
        <div class="validation-message">
            {{ $errors->first('user.email_credentials') }}
        </div>
        <div class="help-block">
            {{ trans('cruds.user.fields.email_credentials_helper') }}
        </div>
    </div>
